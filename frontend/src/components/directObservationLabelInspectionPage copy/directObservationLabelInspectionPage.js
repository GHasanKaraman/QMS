          ...
          <Autocomplete
            ...
            onChange={async (_, value) => {
              ...
              if (value != null) {
                ...
                await formOpen("labelInspection", station, value.partNum);
                if (details) {
            ...
            <AccordionDetails>
              ...
              >
                ...
                <Typography
                  ...
                  sx={{ m: "0 0 -20px 0", minWidth: "250px" }}
                >
                  Allergen statement is correct?
                </Typography>
                <ToggleButtonCheck
                  style={{ gridColumn: "span 4" }}
                  alignment={formik.values.isAllergenStatementCorrect}
                  onChange={(value) => {
                    formik.setFieldValue("isAllergenStatementCorrect", value);
                  }}
                  error={
                    !!formik.touched.isAllergenStatementCorrect &&
                    !!formik.errors.isAllergenStatementCorrect
                  }
                  options={[
                    {
                      label: "Yes",
...
export default DirectObservationLabelInspectionPage;
